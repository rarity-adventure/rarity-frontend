...
import GlobalStatsLoader from './Loader'

function GlobalStatsData({ data }: { data: { globals: any[]; classes: any[]; levels: any[] } }): JSX.Element {
...
export default function GlobalStats(): JSX.Element {
    ...
    return (
        <div className="w-full z-10">
            ...
            {data && data.globals[0] ? <GlobalStatsData data={data} /> : <GlobalStatsLoader />}
        </div>
    )
}
