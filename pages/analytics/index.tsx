...
export function Analytics({ fallback }): JSX.Element {
                                            ...
                                            return (
                                                <div key={level.id}>
                                                    ...
                                                    <div className="mt-1 text-xs">
                                                        ...
                                                        <span>
                                                            {((level.count * 100) / data.globals[0].summoners).toFixed(
                                                                2
                                                            )}
                                                            %
                                                        </span>
                                            ...
                                            return (
                                                <div key={_class.id}>
                                                    ...
                                                    <div className="mt-1 text-xs">
                                                        ...
                                                        <span className="ml-3">: </span>
                                                        <span>
                                                            {((_class.count * 100) / data.globals[0].summoners).toFixed(
                                                                2
                                                            )}
                                                            %
                                                        </span>
...
export async function getStaticProps() {
    return {
        props: {
            fallback: {
                analytics: {
                    globals: [{ summoners: 0, owners: 0 }],
                    classes: [{ id: 0, count: 0 }],
                    levels: [{ id: 0, count: 0 }],
                },
            },
        },
