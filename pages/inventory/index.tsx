                ...
                {items.length > 0 ? (
                    <>
                        ...
                        <div className="p-2 ">
                            ...
                            <div className="grid grid-cols-1 rounded-lg sm:grid-cols-2 lg:grid-cols-4 mt-7 items-center border-2 bg-item-background border-white gap-2 p-5 xl:gap-5 max-h-screen overflow-scroll">
                                {items.map((i) => {
